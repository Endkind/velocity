...
```bash
docker run -it -d -p 25565:25565 --name endkind-velocity endkind/velocity:4.1.2-SNAPSHOT
```
...
docker run -it -d -p 25565:25565 --name endkind-velocity -v endkind-velocity:/velocity --restart=always endkind/velocity:4.1.2-SNAPSHOT
```
...
<!-- prettier-ignore -->
```bash
docker build -t endkind/velocity:4.1.2-SNAPSHOT .
```
