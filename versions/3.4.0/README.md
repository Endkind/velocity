...
```bash
docker run -it -d -p 25565:25565 --name endkind-velocity endkind/velocity:3.4.0
```
...
docker run -it -d -p 25565:25565 --name endkind-velocity -v endkind-velocity:/velocity --restart=always endkind/velocity:3.4.0
```
...
<!-- prettier-ignore -->
```bash
docker build -t endkind/velocity:3.4.0 .
```
