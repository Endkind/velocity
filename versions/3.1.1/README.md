...
```bash
docker run -it -d -p 25565:25565 --name endkind-velocity endkind/velocity:3.1.1
```
...
docker run -it -d -p 25565:25565 --name endkind-velocity -v endkind-velocity:/velocity --restart=always endkind/velocity:3.1.1
```
...
<!-- prettier-ignore -->
```bash
docker build -t endkind/velocity:3.1.1 .
```
